...
public class MainActivity extends Activity {
	...
	class MainAdapter extends ThreeLevelExpandableAdapter {
		...
		public int getThreeLevelCount(int firstLevelPosition,
			...
			return getGroup(firstLevelPosition).child.get(secondLevelPosition).child.size();
		}
		...
		public View getThreeLevleView(int firstLevelPosition,
			...
			Level3 level3= getGrandChild(firstLevelPosition,secondLevelPosition,ThreeLevelPosition);
		...
		public Level3 getGrandChild(int groupPosition, int childPosition,
			...
			return getChild(groupPosition, childPosition).child.get(grandChildPosition);
		}
